...
class LinkPreview extends StatefulWidget {
  ...
  /// preview data again.
  final void Function(PreviewDataModel) onPreviewDataFetched;
  ...
  final Widget Function(BuildContext, PreviewDataModel)? previewBuilder;
...
class _LinkPreviewState extends State<LinkPreview>
  ...
  Widget _bodyWidget(PreviewDataModel data, double width) {
  ...
  Future<PreviewDataModel> _fetchData(String text) async {
    setState(() {
  ...
  Future<void> _handlePreviewDataFetched(PreviewDataModel previewData) async {
  ...
  bool _hasData(PreviewDataModel? previewData) =>
  ...
  Widget _minimizedBodyWidget(PreviewDataModel data) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
