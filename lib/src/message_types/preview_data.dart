...
@JsonSerializable()
@immutable
abstract class PreviewDataModel extends Equatable {
  /// Creates preview data.
  const PreviewDataModel._({
    this.description,
    this.image,
    this.link,
    this.title,
  ...
  const factory PreviewDataModel({
    String? description,
  ...
  factory PreviewDataModel.fromJson(Map<String, dynamic> json) =>
      _$PreviewDataModelFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$PreviewDataModelToJson(this);
}

/// A utility class to enable better copyWith.
class _PreviewData extends PreviewDataModel {
  const _PreviewData({
    super.description,
    super.image,
    super.link,
