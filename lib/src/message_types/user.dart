...
abstract class UserModel extends Equatable {
  ...
  const UserModel._({
    ...
    this.role,
    this.updatedAt,
    required this.isBase64UrlOfAvatar,
    this.bytes,
  });
  ...
  const factory UserModel({
    ...
    Role? role,
    int? updatedAt,
    required bool isBase64UrlOfAvatar,
    dynamic bytes,
  }) = _User;
  ...
  final bool isBase64UrlOfAvatar;
...
class _User extends UserModel {
  const _User({
    ...
    super.updatedAt,
    super.bytes,
    super.isBase64UrlOfAvatar = false,
  }) : super._();
  ...
  UserModel copyWith({
    ...
    dynamic isBase64UrlOfAvatar = _Unset,
    dynamic bytes = _Unset,
  }) =>
      _User(
        bytes: bytes == _Unset ? this.bytes : bytes,
        isBase64UrlOfAvatar: isBase64UrlOfAvatar == _Unset
            ? this.isBase64UrlOfAvatar
            : isBase64UrlOfAvatar,
