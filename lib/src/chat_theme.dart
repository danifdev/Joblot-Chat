...
const inputColor = Color(0x0F323247);

///
const chatBg = Color(0xFFF8F8F8);
...
/// N7 with opacity.
const neutral7WithOpacity = Color.fromARGB(66, 255, 255, 255);

/// Primary.
const primary = Color(0xff4A65F5);

/// Secondary.
const secondary = Color.fromRGBO(255, 205, 0, 1);

/// Secondary dark.
const secondaryDark = Color(0xff2b2250);

const greyBg = Color(0xffEBEBEB);
...
abstract class ChatTheme {
  ...
  const ChatTheme({
    required this.secondaryColorBg,
...
class DefaultChatTheme extends ChatTheme {
  ...
  const DefaultChatTheme({
    ...
    super.errorIcon,
    super.inputBackgroundColor = inputBg,
    ...
    super.inputMargin =
        const EdgeInsets.only(top: 6, bottom: 8, left: 12, right: 12),
    super.inputPadding = const EdgeInsets.fromLTRB(24, 20, 24, 20),
    super.inputTextColor = inputColor,
    ...
    super.messageBorderRadius = 8,
    super.messageInsetsHorizontal = 6,
    super.messageInsetsVertical = 2,
    super.primaryColor = primary,
    super.receivedEmojiMessageTextStyle = const TextStyle(fontSize: 28),
    ...
    super.sendingIcon,
    super.sentEmojiMessageTextStyle = const TextStyle(fontSize: 28),
    ...
    super.statusIconPadding = const EdgeInsets.fromLTRB(8, 0, 8, 4),
