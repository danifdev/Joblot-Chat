...
class TextMessage extends StatelessWidget {
  ...
  Widget _linkPreview(
    ...
    final linkDescriptionTextStyle = (message.isOwner ?? false)
    ...
    final linkTitleTextStyle = (message.isOwner ?? false)
  ...
  Widget _textWidgetBuilder(
    ...
    final bodyLinkTextStyle = (message.isOwner ?? false)
        ? InheritedChatTheme.of(context).theme.sentMessageBodyLinkTextStyle
        : InheritedChatTheme.of(context).theme.receivedMessageBodyLinkTextStyle;
    final bodyTextStyle = (message.isOwner ?? false)
        ? theme.sentMessageBodyTextStyle
        : theme.receivedMessageBodyTextStyle;
    final boldTextStyle = (message.isOwner ?? false)
        ? theme.sentMessageBodyBoldTextStyle
        : theme.receivedMessageBodyBoldTextStyle;
    final codeTextStyle = (message.isOwner ?? false)
        ? theme.sentMessageBodyCodeTextStyle
        : theme.receivedMessageBodyCodeTextStyle;
    final emojiTextStyle = (message.isOwner ?? false)
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(
        top: theme.messageInsetsVertical,
        left: theme.messageInsetsHorizontal,
        right: theme.messageInsetsHorizontal,
        bottom: 4,
      ),
      child: _textWidgetBuilder(context, enlargeEmojis),
    );
  }
}
